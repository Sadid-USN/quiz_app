...
class Themes {
  static final light = ThemeData(
    ...
    textTheme: TextTheme(
      ...
      labelSmall:  GoogleFonts.ptSerif(
        color: Colors.white,
        fontWeight: FontWeight.bold,
        fontSize: 16,
      ),
...
const Color surfaceColor = Color(0XFF1F4061); // Slightly lighter than background

const Color onDarkPrimary = Colors.black; // White font on dark primary
const Color onDarkSecondary = Colors.black; // White font on dark secondary
const Color onDarkError = Colors.black; // White font on dark error
const Color onDarkBackground = Colors.black; // White font on dark background
const Color onDarkSurface = Colors.black; // White font on dark surface
